    ...
    MetalGuidedContext() {
        @autoreleasepool {
            ...
            ok = prepare_guide && prepare_plane && prepare_planes_pair
                ...
                && reconstruct_low && reconstruct_low_pair && visual_guard;
